    ...
    <div className="min-h-screen flex items-center justify-center px-4">
      ...
      >
        ...
        <button
          ...
          className="w-full flex items-center justify-center gap-3 rounded-lg border border-stone-300 bg-white py-2 text-sm font-medium text-stone-700 hover:bg-stone-50 disabled:opacity-50"
        >
        ...
        <div className="relative">
          ...
          <div className="relative flex justify-center text-xs">
            <span className="bg-white px-2 text-stone-500">或使用邮箱</span>
          </div>
        </div>
...
function mapError(err) {
  ...
  if (code.includes('popup-closed-by-user')) return '登录已取消'
  if (code.includes('popup-blocked')) return '浏览器阻止了弹窗，请允许后重试'
